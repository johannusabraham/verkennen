...
while True:
    ...
    #==kamer_7==#
        ...
        if ruby_kans == 1:
            ...
            player_ruby += 1
        print('er is verder niks in deze kamer dus besluit je naar een van de twee deuren te gaan')
        kamer = int(input('kamer 2 of 8 '))
        print('')
        time.sleep(1)
    #==kamer_2==#
    elif kamer == 2:
        ...
        if antwoord == rando1 + rando2:
            ...
            print('Je zie twee deuren in de kamer.')
        kamer = int(input('kamer 6 of 8 = '))
        print('')
        time.sleep(1)
    #==kamer_6==#
    elif kamer == 6:
    ...
    #==kamer_3==#
        ...
        if player_ruby >= 0:
            item = input('wat wil je?[schild = 1,zwaard = 1,boog = 1,toverstok = 1,sleutel = 2] ')
            if item == 'schild':
                player_defense += 1
                player_ruby -= 1
            elif item == 'boog':
                ...
                player_ruby -= 1
            if player_ruby >= 1:
                print('de goblin zeg "ik voel dat je nog ruby(s) hebt dus als je wilt kan je nog iets kopen"')
                ...
                print('met geen rubys meer vraagt de goblin je vriendelijk om zijn kamer te verlaten')
        else:
            print('maar met geen rubys moet je maar naar de volgende kamer')
        kamer = 4
        print('')
        time.sleep(1)
    #==kamer_4==#
        ...
        if mega_zombie_hit_damage <= 0:
            print('Jij hebt een te goede verdediging voor de mega zombie, hij kan je geen schade doen.')
        else:
